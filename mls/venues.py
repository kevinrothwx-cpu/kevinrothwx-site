...
capacity, and nws_unsupported flag for the three Canadian sites.
...
# Keys are ESPN team IDs verified against the live 2026 scoreboard.
# Prior version of this file had 12 team IDs from an earlier (incorrect)
# assumption — matches involving those teams were being silently dropped
# because get_stadium() returned None. Fixed 2026-07-18 by cross-checking
# against ESPN's soccer/usa.1 endpoints.
...
# EOF-CANARY 2026-07-18-mls-venues-id-fix
