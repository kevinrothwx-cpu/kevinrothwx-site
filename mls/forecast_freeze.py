"""mls.forecast_freeze — lock a match's hourly forecast at kickoff.

Mirrors nascar.forecast_freeze and mlb.forecast_freeze. Once a match has
kicked off, the displayed hourly window stops updating from NWS (which
rolls past hours off) and serves the frozen snapshot. This keeps the
in-match user view stable.
"""
...
_DISK_FILE = "mls_forecast_freeze.json"
