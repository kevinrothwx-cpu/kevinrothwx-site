"""nfl.analysis — auto-generated weather summary for NFL games.

PURE WEATHER FACTS ONLY. No football-impact speculation. Mirrors
cfb/analysis.py — Kevin's brand stance is 'built by a meteorologist,
not AI.' No commentary on kicking, passing, ball handling, gameplans.

Domed venues get a one-line indoor notice instead.
"""
...
def generate_analysis(game: dict) -> dict:
    ...
    elif roof == "fixed_canopy":
        parts.append("Stadium has a fixed canopy but open sides; surface weather still applies.")
